...
const platforms = [
  ...
  { name: "Pinterest", strengths: ["High purchase-intent audience in planning/discovery mode", "Strong for visually-driven lifestyle categories", "Shopping Spotlight for peak retail moments", "Affluent female audience regionally"], kpis: ["Awareness: CPM $4–$12, Saves, Closeups", "Traffic: CPC $0.50–$2.00, Outbound Clicks", "Conversions: ROAS 2–5x (with catalogue)"], audienceFit: "Female 25–44, interested in home, fashion, beauty, weddings, travel, lifestyle. Affluent. Users actively planning purchases — high intent.", capabilities: "Standard Pins, Video Pins, Max-Width Video, Shopping Ads, Dynamic Product Ads, Collections, Lead Ads. Pinterest Tag required for conversion tracking.", evaluate: "Is the category visually driven (fashion, beauty, home, weddings)? → Strong fit. Is the target audience female 25–44? → Pinterest's core demo. Do we have a product catalogue? → Enables Shopping Ads. Is the objective discovery-to-purchase? → Pinterest excels here. Direct response at scale? → Pinterest is a discovery platform, not DR.", gcc: "GCC audience skews affluent female. Shopping Spotlight effective for DSF, Eid gifting. Less developed than other platforms regionally but growing.", minBudget: "$3K/month", color: "red" },
...
const programmaticEcosystem = [
  ...
  { category: "AUDIO", description: "Audio and music streaming advertising platforms.", vendors: [
    ...
    { name: "Anghami", type: "Arabic Music Streaming", what: "Leading Arabic music and podcast platform. Ad-supported tier. Audio, display, and video formats. Strong MENA reach.", gcc: "CENTRAL region. Dominant Arabic audio platform.", bestFor: "Arabic audiences, MENA audio, contextual", minBudget: "Via DSP or direct", regions: ["CENTRAL"] },
  ]},
      ...
      <div style={{ minHeight: "100vh", background: "#0b1120", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'DM Sans', 'Segoe UI', sans-serif" }}>
        ...
        <div style={{ width: 380, padding: 40, background: "#141c2e", borderRadius: 16, border: "1px solid #1e2d45", boxShadow: "0 20px 60px rgba(0,0,0,.5)" }}>
          <div style={{ textAlign: "center", marginBottom: 32 }}>
            ...
            <div style={{ fontSize: 22, fontWeight: 800, color: "#e2e8f0", marginTop: 4 }}>Planning Playbook</div>
          ...
          <button onClick={handleLogin} style={{ width: "100%", padding: "12px", borderRadius: 8, border: "none", background: "#3b82f6", color: "#fff", fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}>Sign In</button>
