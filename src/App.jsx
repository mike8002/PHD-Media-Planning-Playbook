  ...
  if (!isLoggedIn) {
    return (
      <div style={{ minHeight: "100vh", background: "#0b1120", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'DM Sans', 'Segoe UI', sans-serif" }}>
        ...
        <div style={{ width: 380, padding: 40, background: "#141c2e", borderRadius: 16, border: "1px solid #1e2d45", boxShadow: "0 20px 60px rgba(0,0,0,.5)" }}>
          <div style={{ textAlign: "center", marginBottom: 32 }}>
            <div style={{ marginBottom: 12 }}><svg width="120" height="40" viewBox="0 0 120 40"><rect width="120" height="40" rx="4" fill="#7B2D8E"/><text x="60" y="27" textAnchor="middle" fill="white" fontSize="22" fontWeight="800" fontFamily="Arial,sans-serif">PHD</text></svg></div><div style={{ fontSize: 11, fontWeight: 700, color: "#7B2D8E", letterSpacing: "0.05em" }}>Intelligence. Connected.</div>
          ...
          <button onClick={handleLogin} style={{ width: "100%", padding: "12px", borderRadius: 8, border: "none", background: "linear-gradient(135deg, #7B2D8E, #5B1D6E)", color: "#fff", fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}>Sign In</button>
          <div style={{ fontSize: 9, color: "#334155", textAlign: "center", marginTop: 16 }}>Contact your team lead for access credentials</div>
        </div>
      </div>
    );
  }
