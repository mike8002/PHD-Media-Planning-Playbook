...
const programmaticEcosystem = [
  ...
  { category: "CTV / Connected TV", description: "Connected TV and streaming platforms offering ad-supported inventory by region.", vendors: [
    ...
    { name: "Skyscale", type: "CTV / Video Network", what: "Omnichannel media buying platform with global reach. Covers CTV, linear TV, OOH, and digital video through global deals. One of the few platforms offering truly integrated cross-channel buying.", gcc: "Available WEST and EAST. Cross-regional CTV capabilities.", bestFor: "Cross-regional CTV, multi-market video", minBudget: "Contact vendor", regions: ["WEST","EAST"] },
